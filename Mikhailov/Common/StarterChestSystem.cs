...
public sealed class StarterChestSystem : ModSystem
{
    ...
    private static void FillModChest(Chest chest)
    {
        ...
        int[] items = { ModContent.ItemType<MikhailovskyAK>(), ModContent.ItemType<HeatingPipe>(), ModContent.ItemType<GopArrow>(), ModContent.ItemType<MikhailovTear>(), ModContent.ItemType<RailBorer>(), ModContent.ItemType<Screwdriver>() };
